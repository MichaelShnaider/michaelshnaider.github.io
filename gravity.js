...
function init() {
    ...
    for ( var i = 0; i < elements.length; i ++ ) {
        ...
        element.style.width = properties[i][2]
...
/*window.addEventListener('keydown',function(e){
	...
	if(e.keyCode==32){
	...
	else if('1234567890QWERTYUIOPASDFGHJKLZXCVBNM'.indexOf(char)!=-1){
		var element = document.createElement('div');
		...
		properties.push( [ Math.random() * ( window.innerWidth / 2 ), - 200, 70, 70 ] );
